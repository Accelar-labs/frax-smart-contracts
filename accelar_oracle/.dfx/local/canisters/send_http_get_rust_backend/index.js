...
import { idlFactory } from './send_http_get_rust_backend.did.js';
export { idlFactory } from './send_http_get_rust_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SEND_HTTP_GET_RUST_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./send_http_get_rust_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the send_http_get_rust_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./send_http_get_rust_backend.did.js")._SERVICE>}
 */
export const send_http_get_rust_backend = createActor(canisterId);
