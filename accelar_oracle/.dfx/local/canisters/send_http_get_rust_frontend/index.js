...
import { idlFactory } from './send_http_get_rust_frontend.did.js';
export { idlFactory } from './send_http_get_rust_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SEND_HTTP_GET_RUST_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./send_http_get_rust_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the send_http_get_rust_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./send_http_get_rust_frontend.did.js")._SERVICE>}
 */
export const send_http_get_rust_frontend = createActor(canisterId);
